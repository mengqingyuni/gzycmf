...
<script>
 $(function(){
	 var wsurl = 'ws://127.0.0.1:9505/model/home/controller/Index/action/demo';
	 var websocket;
	 var i = 0;
	 if(window.WebSocket){
		 ...
		 websocket.onopen = function(evevt){
			 ...
			 $('.show-area').append('<p class="bg-info message">
<i class="glyphicon glyphicon-info-sign"></i>Connected to WebSocket server!</p>');
		 }
      //收到消息
      websocket.onmessage = function(event){
		  ...
		  i++;
		  if(type == 'usermsg'){
			  $('.show-area').append('<p class="bg-success message"><i class="glyphicon glyphicon-user">
</i><a name="' + i + '"></a><span class="label label-primary">' + uname + ' say: </span>' + umsg + '</p>');
		  }
		  if(type == 'system'){
			  $('.show-area').append('<p class="bg-warning message"><a name="' + i + '">
